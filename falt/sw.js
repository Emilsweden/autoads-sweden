...
const SKAL = [
  ...
  './js/dorr.js', './js/redigera.js', './js/karta.js', './js/kartmotor.js', './js/geo.js', './js/anteckningar.js', './js/kalender.js', './js/bokade.js', './js/tider.js', './js/flode.js', './js/listor.js', './js/dashboard.js', './js/admin.js',
