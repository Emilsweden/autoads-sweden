...
|---|---|
| **BOKAT** | Formulär för förnamn, efternamn, mobil, datum, tid och kommentar. Adressen blir Bokad. |
...
- **Bokningar** — bokade besiktningar per dag, med ring, karta, markera genomförd och avboka.
...
| `js/listor.js` | Dörrlistor och bokningskalender |
